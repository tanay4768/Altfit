...
class LoginScreen extends StatelessWidget {
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    top: width / 1.2,
                    left: width * 0.05,
                    child: Text("Login", style: theme.textTheme.displayMedium),
                  ),
                ],
              ),
            ),
            Flexible(
              flex: 1,
              child: _buildLoginForm(height, width, theme),
            ),
          ],
        ),
      ),
  ...
  Widget _buildLoginForm(double height, double width, ThemeData theme) {
    return Padding(
          ...
          Spacer(), 
            Align(
              ...
              child: IconButton.filled(
                onPressed: () => controller.handleLogin(email: email.text, password: password.text),
